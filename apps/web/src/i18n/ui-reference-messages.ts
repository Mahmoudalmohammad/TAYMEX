...
export interface UiReferenceCopy {
  ...
  statusActive: string; statusDraft: string; pagination: string; previous: string; next: string; pageOf: (page:number,count:number)=>string;
...
export const uiReferenceMessages: Record<TaymexLocale, UiReferenceCopy> = {
  ar: {
    ...
    dataTitle:'الجداول والبحث', search:'بحث', clearSearch:'مسح البحث', tableLabel:'جدول تمثيلي', colName:'العنصر', colStatus:'الحالة', colAmount:'القيمة', statusActive:'نشط', statusDraft:'مسودة', pagination:'ترقيم الصفحات', previous:'السابق', next:'التالي', pageOf:(p,c)=>`الصفحة ${p} من ${c}`,
  ...
  tr: {
    ...
    dataTitle:'Tablolar ve arama', search:'Ara', clearSearch:'Aramayı temizle', tableLabel:'Temsili tablo', colName:'Öğe', colStatus:'Durum', colAmount:'Değer', statusActive:'Aktif', statusDraft:'Taslak', pagination:'Sayfalama', previous:'Önceki', next:'Sonraki', pageOf:(p,c)=>`Sayfa ${p} / ${c}`,
  ...
  en: {
    ...
    dataTitle:'Tables and search', search:'Search', clearSearch:'Clear search', tableLabel:'Representative table', colName:'Item', colStatus:'Status', colAmount:'Value', statusActive:'Active', statusDraft:'Draft', pagination:'Pagination', previous:'Previous', next:'Next', pageOf:(p,c)=>`Page ${p} of ${c}`,
